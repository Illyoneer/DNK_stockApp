...
import ru.glushko.dnkstockapp.presentation.viewutils.tabAdapter.ManagementTabAdapter
...
class ManagementFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _managementFragmentBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_management, container, false)
        val pagerAdapter = ManagementTabAdapter(this)
        _managementFragmentBinding.viewPager2.adapter = pagerAdapter

        TabLayoutMediator(_managementFragmentBinding.tabLayout,
